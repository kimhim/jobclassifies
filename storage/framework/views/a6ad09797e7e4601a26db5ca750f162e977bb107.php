		...
		<div class="col-md-8 col-md-offset-2">
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					<div class="col-md-12">
						<form class="form-horizontal" role="form" method="POST" action="<?php echo e(route('job.update',$job_edit->id)); ?>">
							...
							<div class="form-group<?php echo e($errors->has('job_title') ? ' has-error' : ''); ?>">
								...
								<div class="col-md-9">
									<input id="job_title" type="text" class="form-control" name="job_title"
										value="<?php echo e($job_edit->job_title); ?>" placeholder="Job title"> 
							...
							<div class="form-group<?php echo e($errors->has('job_description') ? ' has-error' : ''); ?>">
								...
								<div class="col-md-9">
									<textarea name="job_description" id="job_description" class="form-control" rows="5" cols="70" placeholder="Job Description"><?php echo e($job_edit->job_description); ?></textarea>
							...
							<div class="form-group<?php echo e($errors->has('job_requirement') ? ' has-error' : ''); ?>">
								...
								<div class="col-md-9">
									<textarea name="job_requirement" id="job_requirement" class="form-control" rows="5" cols="70" placeholder="Job Requirement"><?php echo e($job_edit->job_requirement); ?></textarea>
								...
								<div class="col-md-9">
									...
									<select name="job_categories" class="form-control" id="job_categories">
										...
										<?php foreach($array_job_categories as $key=>$category): ?>
											<option value="<?php echo e($key); ?>" <?php echo ($key== old('job_categories') || $job_edit->job_categories==$key)?'selected':'';?>><?php echo e($category); ?></option>
										<?php endforeach; ?>
									</select>
							...
							<div class="form-group<?php echo e($errors->has('job_closing_date') ? ' has-error' : ''); ?>">
								...
								<div class="col-md-9">
									<input id="job_closing_date" type="text" class="form-control" name="job_closing_date"
										value="<?php echo e($job_edit->job_closing_date); ?>" > 
							...
							<div class="form-group<?php echo e($errors->has('job_priority') ? ' has-error' : ''); ?>">
								...
								<div class="col-md-9">
									...
									<select name="job_priority" class="form-control" id="job_categories">
										...
										<option value="<?php echo e($key); ?>" <?php echo ($key==old('job_priority') || $job_edit->job_priority==$key)?'selected':'';?>><?php echo e($priority); ?></option>
										<?php endforeach; ?>
									</select>
