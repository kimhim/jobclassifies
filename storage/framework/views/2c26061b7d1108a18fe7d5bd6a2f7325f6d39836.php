...
<!--                     route('user.registration')  -->
                        ...
                        <div class="form-group<?php echo e($errors->has('email') ? ' has-error' : ''); ?>" id="group-email">
                        ...
                        <div class="form-group<?php echo e($errors->has('user_role') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
								<select id="user_role" class="form-control" name="user_role">
									...
									{<?php foreach($user_roles as $userlist): ?>
									   <option value='<?php echo e($userlist->id); ?>'><?php echo e($userlist->title); ?></option>
									<?php endforeach; ?>
								</select>
