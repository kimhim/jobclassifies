        ...
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" enctype="multipart/form-data" role="form" method="POST" action="<?php echo e(route('user.update')); ?>">
                        ...
                        <div class="form-group<?php echo e($errors->has('user_role') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
								<span class="label label-warning"><?php echo e(@$user->title); ?></span>
