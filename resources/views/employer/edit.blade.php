        ...
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" enctype="multipart/form-data" role="form" method="POST" action="{{ route('user.edit_profile') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('user_role') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
								<span class="label label-warning">{{@$user_roles[0]->title}}</span>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-2">
                            	<div id="dvPreview">
                            		@if($user->avatar)
                            			<img src="{{asset('images/avatars/'.$user->avatar)}}" alt="" title="" class="img-responsive img-thumbnail" style="width:113px;height:150px;"/>
                            		@endif
                            	</div>	
                            </div>
                        </div>
                        ...
                        <div class="form-group{{ $errors->has('phone') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
								<input type="text" min="8" max="10" size="10" name="phone" class="form-control" value="{{$user->phone}}" />
                                @if ($errors->has('phone'))
                                    <span class="help-block">
